...
import org.gong.bmw.BuildConfig;
...
abstract class AbstractProgressResourceSubscriber<T> implements Observer<T>, Subscriber<T> {

    private static final boolean DEBUG_TAG = BuildConfig.DEBUG;
    ...
    /**
     * {@link AbstractProgressResourceSubscriber#onSubscribe(Subscription)}
     * set var1 used for : {@link Subscription#request(long)} 's param
     *
     * @param var1 请求次数
     * @return AbstractProgressObserver
     */
    public AbstractProgressResourceSubscriber<T> setSubscribeRequest(long var1) {
        requestVar1 = var1;
        return this;
    }
